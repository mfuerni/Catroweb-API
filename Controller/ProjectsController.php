...
class ProjectsController extends Controller
{
  ...
  public function projectIdDeleteAction(Request $request, $id)
  {
    ...
    try {
      ...
      $responseCode = 204;
      $responseHeaders = [];
      $result = $handler->projectIdDelete($id, $responseCode, $responseHeaders);
  ...
  public function projectIdRecommendationsGetAction(Request $request, $id)
  {
    ...
    try {
      ...
      $responseCode = 200;
      $responseHeaders = [];
      $result = $handler->projectIdRecommendationsGet($id, $category, $accept_language, $max_version, $limit, $offset, $flavor, $responseCode, $responseHeaders);
