...
interface ProjectsApiInterface
{
   ...
   */
  public function projectsCategoriesGet(string $max_version = null, string $flavor = null, string $accept_language = null, &$responseCode, array &$responseHeaders);
   ...
   */
  public function projectsExtensionsGet(string $accept_language = null, &$responseCode, array &$responseHeaders);
   ...
   */
  public function projectsTagsGet(string $accept_language = null, &$responseCode, array &$responseHeaders);
